...
VEN_PINTOOL_DIR = os.path.join(PINTOOL_DIR, "../../lib/pintool")
SO = {
    "intel64": os.path.join(VEN_PINTOOL_DIR, "obj-intel64/libqsym.so"),
    "ia32": os.path.join(VEN_PINTOOL_DIR, "obj-ia32/libqsym.so")
}
PIN = find_pin()
